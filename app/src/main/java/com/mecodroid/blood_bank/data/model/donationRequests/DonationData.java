...
public class DonationData {
    ...
    @SerializedName("city")
    @Expose
    private GeneralModel city;
    @SerializedName("clientModel")
    @Expose
    private Client clientModel;
    @SerializedName("blood_type")
    @Expose
    private GeneralModel bloodType;
    ...
    public GeneralModel getCityModel() {
        return city;
    }

    public void setCityModel(GeneralModel city) {
        this.city = city;
    }
    ...
    public GeneralModel getBloodType() {
        return bloodType;
    }

    public void setBloodType(GeneralModel bloodType) {
